...
impl Kind {
    ...
    pub fn image_mode(&self) -> ImageMode {
        match self {
            ...
            | Kind::Plus
            | Kind::Module15Keys
            | Kind::Module32Keys => ImageMode::Jpeg,
        }
    }
    ...
    pub fn image_mirror(&self) -> Mirroring {
        match self {
            ...
            | Kind::Module6Keys
            | Kind::Module15Keys
            | Kind::Module32Keys => Mirroring::None,
    ...
    pub(crate) fn image_colour_order(&self) -> ColourOrder {
        match self {
            ...
            | Kind::Plus
            | Kind::Module15Keys
            | Kind::Module32Keys => ColourOrder::RGB,
        }
    }
...
// As used in https://github.com/abcminiuser/python-elgato-streamdeck
